...
try:
    ...
    if _vapid_priv_env and _vapid_pub_env:
        ...
        print(f"\n⚠️  VAPID keys auto-generades (no persistents). "
              f"Afegeix VAPID_PUBLIC_KEY i VAPID_PRIVATE_KEY a l'entorn de Render "
              f"perquè no canviïn a cada restart. PUBLIC_KEY (20c): {VAPID_PUBLIC_KEY[:20]}…", flush=True)
